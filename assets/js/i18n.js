(() => {
  ...
  ,"What should I do with the €13?":{"es":"¿Qué debería hacer con los 13 €?","fr":"Que devrais-je faire avec les 13 € ?","de":"Was soll ich mit den 13 € machen?","pt":"O que devo fazer com os 13 €?","zh":"我该怎么用这13欧元？","ja":"この13ユーロで何をすべき？","ar":"ماذا يجب أن أفعل بالـ13 يورو؟"}
  ,"You decide what I do with it. Vote now, then come back to see what actually happened.":{"es":"Tú decides qué hago con ellos. Vota ahora y vuelve para ver qué pasó realmente.","fr":"Vous décidez ce que j’en fais. Votez maintenant, puis revenez voir ce qui s’est vraiment passé.","de":"Du entscheidest, was ich damit mache. Stimme jetzt ab und komm zurück, um zu sehen, was wirklich passiert ist.","pt":"Tu decides o que faço com eles. Vota agora e volta para ver o que realmente aconteceu.","zh":"由你决定我怎么用这笔钱。现在投票，然后回来看看实际发生了什么。","ja":"このお金で何をするかはあなたが決めます。今投票して、実際に何が起きたかを見に戻ってきてください。","ar":"أنت من يقرر ما سأفعله بها. صوّت الآن ثم عد لترى ما حدث فعلًا."}
  ,"Use the €13 to flip something":{"es":"Usar los 13 € para comprar y revender algo","fr":"Utiliser les 13 € pour acheter puis revendre quelque chose","de":"Die 13 € nutzen, um etwas zu kaufen und weiterzuverkaufen","pt":"Usar os 13 € para comprar e revender algo","zh":"用13欧元买东西再转卖","ja":"13ユーロで何かを仕入れて転売する","ar":"استخدام الـ13 يورو لشراء شيء وإعادة بيعه"}
  ,"Build and sell a tiny digital product":{"es":"Crear y vender un pequeño producto digital","fr":"Créer et vendre un petit produit numérique","de":"Ein kleines digitales Produkt bauen und verkaufen","pt":"Criar e vender um pequeno produto digital","zh":"制作并出售一个小型数字产品","ja":"小さなデジタル商品を作って販売する","ar":"بناء وبيع منتج رقمي صغير"}
  ,"Try a ridiculous internet hustle":{"es":"Probar una idea absurda para ganar dinero en internet","fr":"Tenter une idée absurde pour gagner de l’argent sur internet","de":"Einen absurden Internet-Hustle ausprobieren","pt":"Experimentar um método absurdo de ganhar dinheiro online","zh":"尝试一个荒谬的互联网赚钱点子","ja":"ばかげたネット副業を試す","ar":"تجربة طريقة عبثية لكسب المال عبر الإنترنت"}
