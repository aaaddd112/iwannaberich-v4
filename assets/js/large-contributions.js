(()=>{
  ...
  const I18N={
    ...
    ja:{kicker:"財政的にはかなり無謀な決断",title:"この実験を支援しますか？",intro:"好きな金額を選んでください。すべての支援が公開実験の一部になります。",custom:"金額を選ぶ",customNote:"€0.50–€10,000 · 金額を自由に入力",customCta:"任意の金額で続ける",big:"もっと大きく",bigNote:"€10,000を超える支援はこちら。",close:"支援オプションを閉じる",foot:"支払いはStripeによって安全に処理されます。支援は任意であり、投資や株式購入ではありません。"},
    ar:{kicker:"قرار مالي مشكوك فيه",title:"هل تريد تمويل التجربة؟",intro:"اختر المبلغ الذي تريده. كل مساهمة تصبح جزءًا من التجربة العلنية.",custom:"اختر المبلغ",customNote:"€0.50–€10,000 · أدخل أي مبلغ",customCta:"المتابعة بالمبلغ المخصص",big:"اذهب إلى أبعد من ذلك",bigNote:"للمساهمات التي تتجاوز €10,000.",close:"إغلاق خيارات الدعم",foot:"تتم معالجة المدفوعات بأمان عبر Stripe. المساهمات طوعية وليست استثمارات أو شراءً لحقوق ملكية."}
  };
  const tiers=[
